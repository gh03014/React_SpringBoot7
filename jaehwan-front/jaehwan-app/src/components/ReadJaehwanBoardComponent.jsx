            ...
            <div>
                <div className = "card col-md-6 offset-md-3">
                    ...
                    <div className = "card-body">
                            ...
                            <button  onClick={this.goToUpdate.bind(this)} style={{marginLeft:"10px"}}>글 수정하기</button>
                            <button  onClick={this.goToDelete.bind(this)} style={{marginLeft:"10px"}}>글 삭제하기</button>
                    </div>
                </div>
